...
class Holding(pydantic.BaseModel):
    ...
    def data_hash(self) -> str:
        ...
        hasher.update(str(self.percentage).encode("utf-8") if self.percentage is not None else b"")
        hasher.update(str(self.position).encode("utf-8") if self.position is not None else b"")
